...
/**
 * @function 自定义为GridView添加下拉刷新和滑到底部自动加载
 * @author weicy
 * @time 2014/09/07
 */
public class PullToRefreshGridViewAdvance extends PullToRefreshBase<GridView>
	 ...
	 *            context
	 */
	public PullToRefreshGridViewAdvance(Context context) {
		this(context, null);
	}
	 ...
	 *            attrs
	 */
	public PullToRefreshGridViewAdvance(Context context, AttributeSet attrs) {
	...
	@Override
	protected GridViewWithHeaderAndFooter createRefreshableView(
			Context context, AttributeSet attrs) {
		GridViewWithHeaderAndFooter gridView = new GridViewWithHeaderAndFooter(
				context, attrs);
		mGridView = gridView;
