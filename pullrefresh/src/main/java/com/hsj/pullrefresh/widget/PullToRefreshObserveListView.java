...
import com.hsj.pullrefresh.widget.FooterLoadingLayout;
import com.hsj.pullrefresh.widget.LoadingLayout;
import com.hsj.pullrefresh.interfaces.ILoadingLayout.State;

/**
 * @author weicy
 * @function 自定义为ListView添加下拉刷新和滑到底部自动加载
 * @time 2014/07/05
 */
public class PullToRefreshObserveListView extends PullToRefreshBase<ObservableListView>
     ...
     */
    public PullToRefreshObserveListView(Context context) {
        this(context, null);
    }
     ...
     * @param attrs   attrs
     */
    public PullToRefreshObserveListView(Context context, AttributeSet attrs) {
    ...
    @Override
    protected ObservableListView createRefreshableView(Context context, AttributeSet attrs) {
        ObservableListView listView = new ObservableListView(context, attrs);
        mListView = listView;
        mListView.setOnScrollListener(this);
        mListView.setId(CHILD_ID);
        return mListView;
    }
