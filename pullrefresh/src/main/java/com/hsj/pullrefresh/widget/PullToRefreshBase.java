...
import com.hsj.pullrefresh.interfaces.IPullToRefresh;
 ...
 *
 * @param <T>
 * @author weicy 引用自Li Hong
 * @time 2014/07/01
 * @function 几乎可以为任意view的子类添加下拉刷新和上拉加载更多功能
 * @since 2013-7-29
 */
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
        implements IPullToRefresh<T> {

    protected static final int CHILD_ID = 0x1000;
